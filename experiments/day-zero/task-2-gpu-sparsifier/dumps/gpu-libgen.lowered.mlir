module {
  ...
  llvm.func @spmm(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr, %arg3: i64, %arg4: i64, %arg5: i64, %arg6: i64, %arg7: i64, %arg8: !llvm.ptr, %arg9: !llvm.ptr, %arg10: i64, %arg11: i64, %arg12: i64, %arg13: i64, %arg14: i64) -> !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> {
    ...
    %28 = llvm.getelementptr %27[%25] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    ...
    %42 = llvm.getelementptr %41[%40] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %43 = llvm.ptrtoint %42 : !llvm.ptr to i64
    %44 = llvm.extractvalue %21[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %45 = llvm.extractvalue %39[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.call @mgpuMemcpy(%45, %44, %43, %24) : (!llvm.ptr, !llvm.ptr, i64, !llvm.ptr) -> ()
    %46 = llvm.call @mgpuStreamCreate() : () -> !llvm.ptr
    %47 = llvm.extractvalue %22[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %48 = llvm.mlir.constant(1 : index) : i64
    %49 = llvm.mlir.zero : !llvm.ptr
    %50 = llvm.getelementptr %49[%47] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %51 = llvm.ptrtoint %50 : !llvm.ptr to i64
    %52 = llvm.mlir.zero : !llvm.ptr
    %53 = llvm.mlir.constant(0 : i8) : i8
    %54 = llvm.call @mgpuMemAlloc(%51, %46, %53) : (i64, !llvm.ptr, i8) -> !llvm.ptr
    ...
    %60 = llvm.insertvalue %47, %59[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %61 = llvm.insertvalue %48, %60[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %62 = llvm.extractvalue %22[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %63 = llvm.mlir.zero : !llvm.ptr
    %64 = llvm.getelementptr %63[%62] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %65 = llvm.ptrtoint %64 : !llvm.ptr to i64
    %66 = llvm.extractvalue %22[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %67 = llvm.extractvalue %61[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.call @mgpuMemcpy(%67, %66, %65, %46) : (!llvm.ptr, !llvm.ptr, i64, !llvm.ptr) -> ()
    %68 = llvm.call @mgpuStreamCreate() : () -> !llvm.ptr
    %69 = llvm.extractvalue %23[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %70 = llvm.mlir.constant(1 : index) : i64
    %71 = llvm.mlir.zero : !llvm.ptr
    %72 = llvm.getelementptr %71[%69] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %73 = llvm.ptrtoint %72 : !llvm.ptr to i64
    %74 = llvm.mlir.zero : !llvm.ptr
    %75 = llvm.mlir.constant(0 : i8) : i8
    %76 = llvm.call @mgpuMemAlloc(%73, %68, %75) : (i64, !llvm.ptr, i8) -> !llvm.ptr
    ...
    %82 = llvm.insertvalue %69, %81[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %83 = llvm.insertvalue %70, %82[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %84 = llvm.extractvalue %23[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    ...
    %89 = llvm.extractvalue %83[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.call @mgpuMemcpy(%89, %88, %87, %68) : (!llvm.ptr, !llvm.ptr, i64, !llvm.ptr) -> ()
    %90 = llvm.call @mgpuStreamCreate() : () -> !llvm.ptr
    ...
    %100 = llvm.call @mgpuMemAlloc(%97, %90, %99) : (i64, !llvm.ptr, i8) -> !llvm.ptr
    ...
    %106 = llvm.insertvalue %91, %105[3, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %107 = llvm.insertvalue %92, %106[3, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %108 = llvm.insertvalue %92, %107[4, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %109 = llvm.insertvalue %93, %108[4, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    ...
    %114 = llvm.extractvalue %15[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %115 = llvm.extractvalue %109[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    llvm.call @mgpuMemcpy(%115, %114, %113, %90) : (!llvm.ptr, !llvm.ptr, i64, !llvm.ptr) -> ()
    %116 = llvm.call @mgpuStreamCreate() : () -> !llvm.ptr
    ...
    %126 = llvm.call @mgpuMemAlloc(%123, %116, %125) : (i64, !llvm.ptr, i8) -> !llvm.ptr
    ...
    %132 = llvm.insertvalue %117, %131[3, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %133 = llvm.insertvalue %118, %132[3, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %134 = llvm.insertvalue %118, %133[4, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %135 = llvm.insertvalue %119, %134[4, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    ...
    %140 = llvm.extractvalue %7[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %141 = llvm.extractvalue %135[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    llvm.call @mgpuMemcpy(%141, %140, %139, %116) : (!llvm.ptr, !llvm.ptr, i64, !llvm.ptr) -> ()
    ...
    llvm.call @mgpuStreamSynchronize(%68) : (!llvm.ptr) -> ()
    llvm.call @mgpuStreamDestroy(%68) : (!llvm.ptr) -> ()
    llvm.call @mgpuStreamSynchronize(%90) : (!llvm.ptr) -> ()
    llvm.call @mgpuStreamDestroy(%90) : (!llvm.ptr) -> ()
    llvm.call @mgpuStreamSynchronize(%116) : (!llvm.ptr) -> ()
    llvm.call @mgpuStreamDestroy(%116) : (!llvm.ptr) -> ()
    %142 = llvm.call @mgpuStreamCreate() : () -> !llvm.ptr
    %143 = llvm.extractvalue %39[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %144 = llvm.extractvalue %61[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %145 = llvm.extractvalue %83[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %146 = llvm.mlir.constant(2 : i32) : i32
    %147 = llvm.mlir.constant(2 : i32) : i32
    %148 = llvm.mlir.constant(0 : i32) : i32
    %149 = llvm.call @mgpuCreateCsr(%18, %18, %20, %143, %144, %145, %146, %147, %148, %142) : (i64, i64, i64, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, i32, i32, !llvm.ptr) -> !llvm.ptr
    %150 = llvm.extractvalue %109[0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %151 = llvm.mlir.constant(0 : i32) : i32
    %152 = llvm.call @mgpuCreateDnMat(%18, %18, %150, %151, %142) : (i64, i64, !llvm.ptr, i32, !llvm.ptr) -> !llvm.ptr
    %153 = llvm.extractvalue %135[0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %154 = llvm.mlir.constant(0 : i32) : i32
    %155 = llvm.call @mgpuCreateDnMat(%18, %18, %153, %154, %142) : (i64, i64, !llvm.ptr, i32, !llvm.ptr) -> !llvm.ptr
    %156 = llvm.mlir.constant(0 : i32) : i32
    %157 = llvm.mlir.constant(0 : i32) : i32
    %158 = llvm.mlir.constant(0 : i32) : i32
    %159 = llvm.call @mgpuSpMMBufferSize(%156, %157, %149, %152, %155, %158, %142) : (i32, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, !llvm.ptr) -> i64
    %160 = llvm.mlir.constant(1 : index) : i64
    %161 = llvm.mlir.zero : !llvm.ptr
    %162 = llvm.getelementptr %161[%159] : (!llvm.ptr, i64) -> !llvm.ptr, i8
    %163 = llvm.ptrtoint %162 : !llvm.ptr to i64
    %164 = llvm.mlir.zero : !llvm.ptr
    %165 = llvm.mlir.constant(0 : i8) : i8
    %166 = llvm.call @mgpuMemAlloc(%163, %142, %165) : (i64, !llvm.ptr, i8) -> !llvm.ptr
    %167 = llvm.mlir.poison : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    ...
    %172 = llvm.insertvalue %159, %171[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %173 = llvm.insertvalue %160, %172[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %174 = llvm.mlir.constant(0 : i32) : i32
    %175 = llvm.mlir.constant(0 : i32) : i32
    %176 = llvm.mlir.constant(0 : i32) : i32
    %177 = llvm.extractvalue %173[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.call @mgpuSpMM(%174, %175, %149, %152, %155, %176, %177, %142) : (i32, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, !llvm.ptr, !llvm.ptr) -> ()
    llvm.call @mgpuDestroySpMat(%149, %142) : (!llvm.ptr, !llvm.ptr) -> ()
    llvm.call @mgpuDestroyDnMat(%152, %142) : (!llvm.ptr, !llvm.ptr) -> ()
    llvm.call @mgpuDestroyDnMat(%155, %142) : (!llvm.ptr, !llvm.ptr) -> ()
    %178 = llvm.extractvalue %39[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.call @mgpuMemFree(%178, %142) : (!llvm.ptr, !llvm.ptr) -> ()
    %179 = llvm.extractvalue %61[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.call @mgpuMemFree(%179, %142) : (!llvm.ptr, !llvm.ptr) -> ()
    %180 = llvm.extractvalue %83[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.call @mgpuMemFree(%180, %142) : (!llvm.ptr, !llvm.ptr) -> ()
    %181 = llvm.extractvalue %173[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.call @mgpuMemFree(%181, %142) : (!llvm.ptr, !llvm.ptr) -> ()
    %182 = llvm.extractvalue %109[0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    llvm.call @mgpuMemFree(%182, %142) : (!llvm.ptr, !llvm.ptr) -> ()
    ...
    %187 = llvm.extractvalue %135[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %188 = llvm.extractvalue %7[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    llvm.call @mgpuMemcpy(%188, %187, %186, %142) : (!llvm.ptr, !llvm.ptr, i64, !llvm.ptr) -> ()
    %189 = llvm.extractvalue %135[0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    llvm.call @mgpuMemFree(%189, %142) : (!llvm.ptr, !llvm.ptr) -> ()
    llvm.call @mgpuStreamSynchronize(%142) : (!llvm.ptr) -> ()
    llvm.call @mgpuStreamDestroy(%142) : (!llvm.ptr) -> ()
