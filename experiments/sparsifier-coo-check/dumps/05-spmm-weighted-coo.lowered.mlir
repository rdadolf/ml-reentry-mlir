module {
  ...
  llvm.func @weighted_spmm(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr, %arg3: i64, %arg4: i64, %arg5: i64, %arg6: i64, %arg7: i64, %arg8: !llvm.ptr, %arg9: !llvm.ptr, %arg10: i64, %arg11: i64, %arg12: i64, %arg13: i64, %arg14: i64) -> !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> {
    ...
    %21 = llvm.call @sparsePositions32(%arg0, %18) : (!llvm.ptr, i64) -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %22 = llvm.call @sparseCoordinates32(%arg0, %18) : (!llvm.ptr, i64) -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %23 = llvm.call @sparseCoordinates32(%arg0, %17) : (!llvm.ptr, i64) -> !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %24 = llvm.extractvalue %21[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %25 = llvm.getelementptr inbounds|nuw %24[%18] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %26 = llvm.load %25 : !llvm.ptr -> i32
    %27 = llvm.zext %26 : i32 to i64
    %28 = llvm.extractvalue %21[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %29 = llvm.getelementptr inbounds|nuw %28[%17] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %30 = llvm.load %29 : !llvm.ptr -> i32
    %31 = llvm.zext %30 : i32 to i64
    llvm.br ^bb1(%27 : i64)
  ^bb1(%32: i64):  // 2 preds: ^bb0, ^bb6
  ...
  ^bb2:  // pred: ^bb1
    ...
    %35 = llvm.getelementptr inbounds|nuw %34[%27] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %36 = llvm.load %35 : !llvm.ptr -> i32
    %37 = llvm.zext %36 : i32 to i64
    %38 = llvm.extractvalue %22[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %39 = llvm.getelementptr inbounds|nuw %38[%32] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %40 = llvm.load %39 : !llvm.ptr -> i32
    %41 = llvm.zext %40 : i32 to i64
    %42 = llvm.icmp "eq" %37, %41 : i64
    llvm.br ^bb4(%42 : i1)
  ^bb3:  // pred: ^bb1
    llvm.br ^bb4(%16 : i1)
  ^bb4(%43: i1):  // 2 preds: ^bb2, ^bb3
    llvm.br ^bb5
  ^bb5:  // pred: ^bb4
    llvm.cond_br %43, ^bb6, ^bb7(%27, %32 : i64, i64)
  ^bb6:  // pred: ^bb5
    %44 = llvm.add %32, %17 : i64
    llvm.br ^bb1(%44 : i64)
  ^bb7(%45: i64, %46: i64):  // 2 preds: ^bb5, ^bb20
    llvm.br ^bb8
  ^bb8:  // pred: ^bb7
    %47 = llvm.icmp "ult" %45, %31 : i64
    llvm.cond_br %47, ^bb9, ^bb22
  ^bb9:  // pred: ^bb8
    %48 = llvm.extractvalue %22[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %49 = llvm.getelementptr inbounds|nuw %48[%45] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %50 = llvm.load %49 : !llvm.ptr -> i32
    %51 = llvm.zext %50 : i32 to i64
    llvm.br ^bb10(%45 : i64)
  ^bb10(%52: i64):  // 2 preds: ^bb9, ^bb14
    %53 = llvm.icmp "slt" %52, %46 : i64
    llvm.cond_br %53, ^bb11, ^bb15
  ^bb11:  // pred: ^bb10
    %54 = llvm.extractvalue %23[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %55 = llvm.getelementptr inbounds|nuw %54[%52] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %56 = llvm.load %55 : !llvm.ptr -> i32
    %57 = llvm.zext %56 : i32 to i64
    %58 = llvm.extractvalue %20[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %59 = llvm.getelementptr inbounds|nuw %58[%52] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    %60 = llvm.load %59 : !llvm.ptr -> f32
    llvm.br ^bb12(%18 : i64)
  ^bb12(%61: i64):  // 2 preds: ^bb11, ^bb13
    %62 = llvm.icmp "slt" %61, %19 : i64
    llvm.cond_br %62, ^bb13, ^bb14
  ^bb13:  // pred: ^bb12
    %63 = llvm.extractvalue %15[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %64 = llvm.mlir.constant(4 : index) : i64
    %65 = llvm.mul %51, %64 overflow<nsw, nuw> : i64
    ...
    %71 = llvm.mul %57, %70 overflow<nsw, nuw> : i64
    ...
    %75 = llvm.fmul %60, %74 : f32
    %76 = llvm.fadd %68, %75 : f32
    %77 = llvm.extractvalue %15[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %78 = llvm.mlir.constant(4 : index) : i64
    %79 = llvm.mul %51, %78 overflow<nsw, nuw> : i64
    %80 = llvm.add %79, %61 overflow<nsw, nuw> : i64
    %81 = llvm.getelementptr inbounds|nuw %77[%80] : (!llvm.ptr, i64) -> !llvm.ptr, f32
    llvm.store %76, %81 : f32, !llvm.ptr
    %82 = llvm.add %61, %17 : i64
    llvm.br ^bb12(%82 : i64)
  ^bb14:  // pred: ^bb12
    %83 = llvm.add %52, %17 : i64
    llvm.br ^bb10(%83 : i64)
  ^bb15:  // pred: ^bb10
    llvm.br ^bb16(%46 : i64)
  ^bb16(%84: i64):  // 2 preds: ^bb15, ^bb21
    %85 = llvm.icmp "ult" %84, %31 : i64
    llvm.cond_br %85, ^bb17, ^bb18
  ^bb17:  // pred: ^bb16
    %86 = llvm.extractvalue %22[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %87 = llvm.getelementptr inbounds|nuw %86[%46] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %88 = llvm.load %87 : !llvm.ptr -> i32
    %89 = llvm.zext %88 : i32 to i64
    %90 = llvm.extractvalue %22[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
  ...
  ^bb18:  // pred: ^bb16
    llvm.br ^bb19(%16 : i1)
  ^bb19(%95: i1):  // 2 preds: ^bb17, ^bb18
    llvm.br ^bb20
  ^bb20:  // pred: ^bb19
    llvm.cond_br %95, ^bb21, ^bb7(%46, %84 : i64, i64)
  ^bb21:  // pred: ^bb20
    %96 = llvm.add %84, %17 : i64
    llvm.br ^bb16(%96 : i64)
  ^bb22:  // pred: ^bb8
  ...
  llvm.func @main() {
    ...
    %5 = llvm.mlir.constant(262145 : i64) : i64
